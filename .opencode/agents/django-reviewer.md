...
For Django architecture patterns and ORM examples, see `skill: backend-patterns`.
For security configuration checklists, see `skill: security-review`.
For testing patterns and fixtures, see `skill: tdd-workflow`.
